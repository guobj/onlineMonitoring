							...
							<c:choose>
								<c:when
									...
									<tr style="border-bottom: 1px solid #adadad;">
										...
										<td class="t5"><fmt:formatDate value="${his.data_time }"
												pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
										<td class="t6"><input type="button" value="查看"
											onclick="look('${his.dev_code }',${his.ms_code})"></td>
									</tr>
								</c:when>
								<c:when test="${fn:startsWith(his.dev_code,'dev5')}">
									<tr style="border-bottom: 1px solid #adadad;">
										...
										<td class="t5"><fmt:formatDate value="${his.data_time }"
												pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
										<td class="t6"><input type="button" value="查看"
											onclick="weather(this,${his.id})"></td>
									</tr>
								</c:when>
								<c:otherwise>
									<tr style="border-bottom: 1px solid #adadad;">
